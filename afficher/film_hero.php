...
$film = $bdd->query("SELECT titre, acteur, resume, genre, duree FROM film WHERE genre like  \"%Super-héro%\";");
?>
<h4 class="text-center font-bold text-xl  mt-20">Films Super-héro</h4>
<?php
if (empty($film)) : ?>
